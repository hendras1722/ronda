<template>
  <div class="h-screen sm:flex sm:justify-center grid place-items-center p-5 bg-[#c8d8f6]">
    <div
      class="glass sm:w-96 sm:rounded-tl-lg sm:rounded-bl-lg h-auto p-8 flex justify-center items-center border border-gray-200">
      <div class="w-full grid place-items-center">
        <div class="text-center text-4xl font-bold ">Ronda Indonesia</div>
        <img src="/ronda.png" width="200" />
        <div class="flex items-center w-full mt-3">
          <div class="border-2 rounded border-white h-1 w-full mt-3"></div>
          <div class="text-nowrap px-3 mt-3 drop-shadow">Login With Google</div>
          <div class="border-2 rounded border-white h-1 w-full mt-3"></div>
        </div>
        <div>
